...
import { Tabs } from "@lexpeed/components-react";

import type { TemplateProps } from "./typings";
...
export default function Template(props: TemplateProps<KcContext, I18n>) {
  ...
  const items = [
    {
      key: "login.ftl",
      label: msg("doLogIn"),
      children: pageId === "login.ftl" ? children : loginPageFormNode,
    },
  ];
  ...
  if (displayInfo || pageId === "register.ftl") {
    items.push({
      ...
      children: pageId === "register.ftl" ? children : registerPageFormNode,
    });
  }
        ...
        <header className={getClassName("kcFormHeaderClass")}>
          ...
          {!(
            ...
            displayRequiredFields ? (
              ...
              showHeaderNode && <h1 id="kc-page-title">{headerNode}</h1>
            )
          ) : displayRequiredFields ? (
            <div className={getClassName("kcContentWrapperClass")}>
              <div
